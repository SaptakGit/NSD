...
if(isset($postdata) && !empty($postdata))
{
	...
	elseif($type==2){
		...
		$sql1="INSERT INTO user_subscription(newo_user_id, subscription_package, starhunt_subscription, subscriptin_start_date, subscriptin_end_date, subscription_status, created_ts) Values('".$userid."',2,'".$password."','".$today."','".$oneYearOn."',1,now())";
	}
	elseif($type==3){
		$sql_3 = "INSERT INTO ott_subscription(newo_user_id,ott_username,ott_password,ott_subscription_date,ott_subscription_status,created_ts) VALUES ('".$userid."','".$username."','".$password."','".$today."',1,now())";
		$sql_starhunt = "INSERT INTO starhunt_subscription(newo_user_id, starhunt_username, starhunt_password, starhunt_subscription_date, starhunt_subscription_status, created_ts) VALUES ('".$userid."','".$username."','".$password."','".$today."',1,now())"; 
		$sql_game = "INSERT INTO game_subscription(newo_user_id, game_username, game_password, game_subscription_date, game_subscription_status, created_ts) VALUES ('".$userid."','".$username."','".$password."','".$today."',1,now())";
